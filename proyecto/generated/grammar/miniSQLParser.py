...
class miniSQLParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "SELECT", "FROM", "WHERE", "AND", "OR", 
                      "POR", "COMA", "IGUAL", "DIFERENTE", "MENOR_QUE", 
                      "MAYOR_QUE", "MENOR_IGUAL", "MAYOR_IGUAL", "INT", 
                      "STRING", "ID", "WS" ]
    ...
    class ColumnsContext(ParserRuleContext):
        ...
        def POR(self):
            return self.getToken(miniSQLParser.POR, 0)
        ...
        def COMA(self, i:int=None):
            if i is None:
                return self.getTokens(miniSQLParser.COMA)
            else:
                return self.getToken(miniSQLParser.COMA, i)
    ...
    class OpContext(ParserRuleContext):
        ...
        def IGUAL(self):
            return self.getToken(miniSQLParser.IGUAL, 0)

        def DIFERENTE(self):
            return self.getToken(miniSQLParser.DIFERENTE, 0)

        def MENOR_QUE(self):
            return self.getToken(miniSQLParser.MENOR_QUE, 0)

        def MAYOR_QUE(self):
            return self.getToken(miniSQLParser.MAYOR_QUE, 0)

        def MENOR_IGUAL(self):
            return self.getToken(miniSQLParser.MENOR_IGUAL, 0)

        def MAYOR_IGUAL(self):
            return self.getToken(miniSQLParser.MAYOR_IGUAL, 0)
